...
let layoutProduct = [
    ...
    { key: "6", width: 35, height: 35, position: "absolute", right: 10, bottom: 45, borderRadius: 11 },
]
...
let layoutProductHori = [
    ...
    { key: "4", width: 140, height: 20, marginTop: 25, marginRight: 40 },
    { key: "5", width: 120, height: 20, marginTop: 25, marginRight: 60 },
    { key: "6", width: 30, height: 30, marginTop: 30, zIndex: 2, marginTop: -29, marginRight: -120, borderRadius: 11 },
]
let layoutProductHome = [
    { key: "1", width: 220, height: 30, marginBottom: 25, marginLeft: -155, marginTop: -20 },
    { key: "2", width: 40, height: 30, zIndex: 3, marginTop: -55, marginRight: -335, borderRadius: 2, marginBottom: 25 },
    ...
    { key: "9", width: 160, height: 20, marginTop: 25, marginRight: -180, zIndex: 3 },
    { key: "10", width: 150, height: 20, marginTop: 25, marginRight: -170, zIndex: 3 },
    { key: "11", width: 120, height: 20, marginTop: 25, marginRight: -150, zIndex: 3 },
]

let layoutProductDetail = [
    { key: "1", width: 400, height: 335, marginTop: -50, marginHorizontal: 5 },
    { key: "2", width: 180, height: 25, marginTop: 20, position: "absolute", left: 15, top: 330 },
    { key: "3", width: 100, height: 25, marginTop: 20, position: "absolute", right: 20, top: 330 },
    { key: "4", width: 160, height: 20, marginTop: 20, position: "absolute", left: 15, top: 365 },
    { key: "5", width: 200, height: 25, marginTop: 20, position: "absolute", left: 15, top: 400 },
    { key: "6", width: 140, height: 25, marginTop: 20, position: "absolute", right: 20, top: 400 },
    { key: "7", width: 160, height: 20, marginTop: 20, position: "absolute", left: 15, top: 440 },
    { key: "8", width: 160, height: 20, marginTop: 20, position: "absolute", left: 15, top: 480 },
    { key: "9", width: 360, height: 335, marginTop: 20, position: "absolute", top: 520 },
